      ...
      <div className="content">
        <div className="row grey-font">
          <div className="column">
            <img className="icon-house" alt="" src={require("/Users/yuliya/bark-frontend/barkdoc-fronend/src/img/homepage/house_icon.png")} />
          ...
          <div className="column">
            <img className="icon-dog-zzz" alt="" src={require("/Users/yuliya/bark-frontend/barkdoc-fronend/src/img/homepage/dog_zzz_icon.png")} />
          ...
          <div className="column">
            <img className="icon-jar" alt="" src={require("/Users/yuliya/bark-frontend/barkdoc-fronend/src/img/homepage/jar_bone.png")} />
